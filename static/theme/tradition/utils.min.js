...
var Hutils = {
    ...
    HLogOut:function(){
        ...
        $.Hconfirm({
            callback:function(){
                $.ajax({type:"Get",url:"/v1/sso/logout",cache:!1,async:!1,dataType:"text",
    ...
    go_entry :function (e){
        var id = $(e).attr("data-id");
        var innerFlag = $(e).attr("data-inner");
        var iframeFlag = $(e).attr("data-iframe");
        ...
        $.HAjaxRequest({
            ...
            success:function(d){
                ...
                if (iframeFlag == "true") {
                    ...
                    iframe.frameBorder = 0;
                    $("#bigdata-platform-subsystem").append(iframe).fadeIn();
                } else {
    ...
    initMenu:function(TypeId,Id,Group1,Group2,Group3){
        ...
        var __genDiv = function (element) {
            ...
            var innerFlag = element.Inner_flag;
    ...
    $.fn.initTraditionMenu = function(param){
        ...
        function sortTree(a){
            ...
            function getRoots(arr){
                ...
                for (var a = 0; a < len; a++){
                    for (b = a + 1; b < len; b++){
                        if (Roots[a].Group_id > Roots[b].Group_id){
                            var tmp = Roots[b];
                            Roots[b] = Roots[a];
                            Roots[a] = tmp;
                        }
        ...
        function genTreeUI(a){
            var opt = "<ul style='width:100%'>"
            for(var i = 0; i < a.length; i++){
                if (a[i].Res_attr == "1") {
                    if  ( parseInt(a[i].dept) <= __DEFAULT.showLevel) {
                        // 叶子信息
                        opt += '<li class="HMenuLiLeaf mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-button--colored" data-openType="'+a[i].Res_open_type+'" data-iframe="'+a[i].New_iframe+'" data-url="'+a[i].Res_url+'" data-id="'+a[i].Res_id+'" data-dept="'+a[i].dept+'" style="margin:0px; text-align: left;font-weight:500;padding-left:'+20+'px; height:'+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; font-size: '+__DEFAULT.showFontSize+'; cursor: pointer;position: relative;">' +
                            '<img style="margin-left: 8px;" src="'+a[i].Res_img+'"/>'+
                            '<span class="HTreeLi" style="height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; position: absolute;margin-left: 3px;">'+a[i].Res_name+'</span></li>'
                    } else {
                        // 叶子信息
                    ...
                    if (parseInt(a[i].dept) == "1"){
                        // 节点信息
                        opt += '<li class="HTreeshowOrHideIconHzw mdl-js-ripple-effect mdl-js-button mdl-button--raised" data-id="'+a[i].Res_id+'" data-dept="'+a[i].dept+'" style="border-bottom: #c7c7c7 solid 1px; margin:0px; text-align: left;font-weight:500;padding-left:'+10+'px; height:48px; line-height: 48px; font-size: '+__DEFAULT.showFontSize+'; cursor: pointer;position: relative;">' +
                            //'<hzw style="height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; width: '+__DEFAULT.showIconWidth+';cursor: cell ;display: inline-block; background-image: url(\''+a[i].Res_img+'\')"></hzw>' +
                            '<span class="HTreeLi" style="height: 48px; line-height: 48px; position: absolute;margin-left: 12px;">'+a[i].Res_name+'</span><hzwy style="margin-right: 12px ;height: 48px; line-height: 48px;" class="icon-double-angle-down pull-right"></hzwy></li>'
                    } else if (parseInt(a[i].dept) <= __DEFAULT.showLevel){
                        // 节点信息
                        opt += '<li class="HTreeshowOrHideIconHzw mdl-js-ripple-effect mdl-js-button mdl-button--raised" data-id="'+a[i].Res_id+'" data-dept="'+a[i].dept+'" style="margin:0px; text-align: left;font-weight:500;padding-left:'+20+'px; height:'+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; font-size: '+__DEFAULT.showFontSize+'; cursor: pointer;position: relative;display: none;">' +
                            //'<hzw style="height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; width: '+__DEFAULT.showIconWidth+';cursor: cell ;display: inline-block; background-image: url(\''+a[i].Res_img+'\')"></hzw>' +
                            '<span class="HTreeLi" style="height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; position: absolute;margin-left: 12px;">'+a[i].Res_name+'</span><hzwy style="margin-right: 12px ;height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'" class="icon-double-angle-down pull-right"></hzwy></li>'
                    } else {
                        // 节点信息
                        opt += '<li class="HTreeshowOrHideIconHzw mdl-js-ripple-effect mdl-js-button mdl-button--raised" data-id="'+a[i].Res_id+'" data-dept="'+a[i].dept+'" style="margin:0px; text-align: left;font-weight:500;padding-left:'+20+'px; height:'+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; font-size: '+__DEFAULT.showFontSize+'; cursor: pointer;position: relative;display: none;">' +
                            //'<hzw style="height: '+__DEFAULT.showLiHeight+'; line-height: '+__DEFAULT.showLiHeight+'; width: '+__DEFAULT.showIconWidth+';cursor: cell ;display: inline-block; background-image: url(\''+a[i].Res_img+'\')"></hzw>' +
